...
@st.cache_data(ttl=600, max_entries=1, show_spinner="구글 시트에서 데이터 로드 중...")
...
def main():
    ...
    CATEGORY_BRAND_MAP = {
        ...
        "캐주얼": [
            "스파오 (정상)", "후아유 (정상)", "폴햄 (정상)", "마인드브릿지 (정상)", 
            "프로젝트M (정상)", "멤버헐리데이 (정상)", "JEEP (정상)", "탑텐 (정상)", 
            "더블에이트 (정상)", "그루브라임플레이 (정상)", "지오다노 (정상)", "행텐 (정상)"
        ]
    }
    ...
    # ────────────────────────────────────────────
        ...
        with subtab_text:
            ...
            cat_input = st.selectbox("카테고리", ["여성", "남성", "스포츠", "신발/잡화", "아웃도어", "캐주얼", "아동잡화"])
